export class ApiCmd {
  public static LOGIN: string = 'qlnb/login';

  public static GET_LIST_TBL_LOAICHAMCONG: string =
    'qlnb/get_list_tbl_loaichamcong';

  public static ADD_TBL_LOAICHAMCONG: string = 'qlnb/add_tbl_loaichamcong';

  public static UPDATE_TBL_LOAICHAMCONG: string =
    'qlnb/update_tbl_loaichamcong';
